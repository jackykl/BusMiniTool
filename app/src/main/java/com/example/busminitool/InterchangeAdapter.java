...
public class InterchangeAdapter extends ArrayAdapter<Bus> implements Filterable {
    ...
    public InterchangeAdapter(List<Bus> busList, Context ctx) {
        super(ctx, R.layout.fragment_interchange_list, busList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            v = inflater.inflate(R.layout.fragment_interchange_list, null);
            // Now we can fill the layout with the right values
            TextView txtBusNum = (TextView) v.findViewById(R.id.txtBusNum);
            TextView txtBusOrign = (TextView) v.findViewById(R.id.txtbusOrign);
            TextView txtBusDest = (TextView) v.findViewById(R.id.txtbusDest);
            ImageView imgBusIcon = (ImageView) v.findViewById(R.id.imgBusIcon);


            holder.BusNumView = txtBusNum;
            holder.busOrign = txtBusOrign;
            holder.busDest = txtBusDest;
        ...
        holder.busOrign.setText(b.getOrignINFO());
        holder.busDest.setText(b.getDestINFO());
    ...
    private static class BusHolder {
        ...
        public TextView busOrign;
        public TextView busDest;
